...
csv_path = "/Volumes/FOBAM_data/8_days/datadir/style_and_fashion_experiment_do_nothing/results/http_requests_url.csv"
new_csv_path = "/Volumes/FOBAM_data/8_days/datadir/style_and_fashion_experiment_do_nothing/results/http_requests_url_with_control_visit.csv"
...
# Query to join http_requests with site_visits on visit_id and determine control_visit status based on site_rank
