...
ads_by_category_accept = metrics_accept_control.get_ads_by_category_table_all_browsers()
...
ads_by_category_reject = metrics_reject_control.get_ads_by_category_table_all_browsers()
...
ads_by_category_do_nothing = (
    metrics_do_nothing_control.get_ads_by_category_table_all_browsers()
)
