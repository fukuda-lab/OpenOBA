...
from custom_command import ExtractAdsCommand
...
manager_params.data_directory = Path("./datadir/ads_screenshots/")
manager_params.log_path = Path("./datadir/ads_screenshots/openwpm.log")
...
with TaskManager(
    ...
    for index, site in enumerate(sites):
        ...
        command_sequence.append_command(GetCommand(site, 10), timeout=30)
